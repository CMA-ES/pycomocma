...
moes = como.Sofomore(list_of_solvers, opts={'archive': False,
                                     ...
                                     'restart': como.RampUpSelector([como.random_restart_kernel, como.best_chv_restart_kernel]),
...
iter = 1
while not moes.stop() and iter < 5000:
    solutions = moes.ask()
...
s.sort_stats('tottime').print_stats(10)
