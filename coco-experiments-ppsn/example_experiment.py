...
##############################################################################
            ...
            while not moes.stop() and fun.evaluations < remaining_evals:
                solutions = moes.ask()
...
suite_name = "bbob-biobj"  # always overwritten when called from system shell
...
observer_options = ObserverOptions({  # is (inherited from) a dictionary
                    'algorithm_info': '"COMO-CMA-ES with restarts (como.random_restart_kernel)"', # CHANGE/INCOMMENT THIS!
